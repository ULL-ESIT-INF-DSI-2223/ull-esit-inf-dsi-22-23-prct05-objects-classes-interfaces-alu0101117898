...
/**
 * Se define la clase `Grass` que implementa la interfaz `Pokemon`.
 */
export class Grass implements Pokemon {
    ...
    * @returns Devuelve un objeto de tipo `Grass`.
     */
    constructor(protected name: string, protected type: string = 'planta',
      protected id: number, protected weak_vs: string = 'fuego') {
    }
