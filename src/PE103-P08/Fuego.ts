...
/**
 * Se define la clase `Fire` que implementa la interfaz `Pokemon`.
 */
export class Fire implements Pokemon {
    ...
    * @returns Devuelve un objeto de tipo `Fire`.
     */
    constructor(protected name: string, protected type: string = 'fuego',
      protected id: number, protected weak_vs: string = 'agua') {
    }
